...
export const ARTIFACTS: Artifact[] = [
  ...
  {
    id: 'art_nazca_hummingbird',
    name: 'Nazca Hummingbird Geoglyph',
    civilizationId: 'caral',
    civilizationName: 'Andean Geoglyph Culture',
    date: '300 BCE - 500 CE',
    startYear: -300,
    material: ["Earth","Pebbles"],
    museum: 'Nazca Desert Archaeological Reserve',
    currentLocation: 'Nazca Desert, Peru',
    importanceScore: 10,
    imageUrl: '/images/artifacts/art_nazca_hummingbird.jpg',
    historicalContext: 'A massive hummingbird geoglyph carved into the desert floor by removing dark pebbles to expose light clay beneath, showing advanced geometric planning.',
    discoveryNotes: 'Studied extensively by Maria Reiche, discovered during early commercial flight routes in Peru.',
    datingMethod: 'Carbon dating of organic material under stone piles and style correlation.',
    scholarlyDebates: 'Debated as either astronomical calendars mapping solstices or sacred ritual pathways dedicated to rain gods.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_caral_pyramids"}]
  },
  {
    id: 'art_kano_dye_pots',
    name: 'Kano Indigo Dye Pits (Kofar Mata)',
    civilizationId: 'hausa',
    civilizationName: 'Hausa States',
    date: '11th Century CE',
    startYear: 1000,
    material: ["Clay","Indigo plant dye","Ash"],
    museum: 'Kofar Mata Dye Pits Monument',
    currentLocation: 'Kano, Nigeria',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_kano_dye_pots.jpg',
    historicalContext: 'Traditional deep-walled mud pits used by guilds of Hausa dyers to coat cotton fabrics in vibrant dark indigo colors.',
    discoveryNotes: 'Continuous operation in Kano since 1498 CE, representing one of the oldest active industrial guilds in West Africa.',
    datingMethod: 'Stratigraphic excavation of oldest pit chambers and oral dynastic logs.',
    scholarlyDebates: 'Serves as evidence of highly specialized local manufacture and trade networks pre-dating European trade contact.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_hausa"}]
  },
  {
    id: 'art_lalibela_cross',
    name: 'Lalibela Rock-Hewn Processional Cross',
    civilizationId: 'aksum',
    civilizationName: 'Kingdom of Aksum',
    date: '12th Century CE',
    startYear: 1100,
    material: ["Gilded bronze","Brass"],
    museum: 'Church of Saint George (Biete Giyorgis)',
    currentLocation: 'Lalibela, Ethiopia',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_lalibela_cross.jpg',
    historicalContext: 'An ornate processional cross carved from solid bronze, featuring intricate ge\'ez inscriptions and interlacing loops.',
    discoveryNotes: 'Kept in the monolithic rock-cut churches of Lalibela, carved directly into the volcanic tuff hills.',
    datingMethod: 'Artistic design mapping and Zagwe dynastic records.',
    scholarlyDebates: 'Debated on its metallurgical connection to older Aksumite copper casting traditions.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_aksum"}]
  },
  {
    ...
    currentLocation: 'London, United Kingdom',
    importanceScore: 10,
    imageUrl: '/images/artifacts/art_cyrus_cylinder.jpg',
    historicalContext: 'A barrel-shaped clay cylinder inscribed in Akkadian cuneiform, detailing Cyrus the Great\'s capture of Babylon and declaration of religious freedoms.',
    discoveryNotes: 'Excavated in the ruins of Babylon in 1879 by Hormuzd Rassam.',
    datingMethod: 'Epigraphical cuneiform style validation.',
    scholarlyDebates: 'Some scholars view it as a routine Mesopotamian royal declaration, while others hail it as the first declaration of universal human rights.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_persia"}]
  },
  {
    id: 'art_chola_temple_murti',
    name: 'Gangaikonda Cholapuram Shiva Murti',
    civilizationId: 'chola',
    civilizationName: 'Chola Dynasty',
    date: '1035 CE',
    startYear: 1035,
    material: ["Granite stone"],
    museum: 'Brihadisvara Temple Sanctuary',
    currentLocation: 'Gangaikonda Cholapuram, India',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_chola_temple_murti.jpg',
    historicalContext: 'A massive carved stone relief sculpture of Shiva crowning his devotee Chandesa, representing the height of Chola plastic art.',
    discoveryNotes: 'Carved during the reign of Rajendra Chola I to commemorate his northern naval campaigns.',
    datingMethod: 'Temple inscription records.',
    scholarlyDebates: 'Represents the transition from traditional wood carving styles to monolithic stone sculpture.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_chola"}]
  },
  {
    id: 'art_moche_earspool',
    name: 'Moche Gold Warrior Earspool',
    civilizationId: 'moche',
    civilizationName: 'Moche Civilization',
    date: '300 CE',
    startYear: 300,
    material: ["Gold","Turquoise","Spondylus shell"],
    museum: 'Museo Tumbas Reales de Sipán',
    currentLocation: 'Lambayeque, Peru',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_moche_earspool.jpg',
    historicalContext: 'An exquisite circular earspool depicting a three-dimensional Moche warrior chief holding a club, decorated with turquoise mosaics.',
    discoveryNotes: 'Excavated from the royal tomb of the Lord of Sipán by Walter Alva in 1987.',
    datingMethod: 'Radiocarbon dating of wood chambers and copper gilding assays.',
    scholarlyDebates: 'Demonstrates the high social status and sophisticated metal welding techniques of coastal Peruvian kingdoms.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_moche"}]
  },
  {
    id: 'art_kongo_mpu_cap',
    name: 'Kongo Kingdom Royal Raffia Cap (Mpu)',
    ...
    currentLocation: 'Tervuren, Belgium',
    importanceScore: 8,
    imageUrl: '/images/artifacts/art_kongo_mpu_cap.jpg',
    historicalContext: 'A tightly woven hat displaying complex geometric spiral patterns, worn by Kongo nobility as a symbol of royal and judicial power.',
    discoveryNotes: 'Collected during early European colonial missions to the Kongo basin.',
    datingMethod: 'Weaving style correlation and European royal collection catalog logs.',
    scholarlyDebates: 'Showcases independent geometric designs comparable to mathematical fractals.',
    evidenceTier: 'Established',
    sources: []
  },
  {
    id: 'art_mapungubwe_scepter',
    name: 'Mapungubwe Gold Scepter',
    civilizationId: 'mapungubwe',
    civilizationName: 'Kingdom of Mapungubwe',
    date: '1220 CE',
    startYear: 1220,
    material: ["Hammered gold foil","Wooden staff core (decayed)"],
    museum: 'Mapungubwe Museum, University of Pretoria',
    currentLocation: 'Pretoria, South Africa',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_mapungubwe_scepter.jpg',
    historicalContext: 'A gold foil scepter detailing spiral grooves, belonging to the sacred leader of Mapungubwe.',
    discoveryNotes: 'Excavated alongside the golden rhino on Mapungubwe Hill.',
    datingMethod: 'Radiocarbon carbon-14 dating of associated organic material.',
    scholarlyDebates: 'Further confirms class division and royal insignia in pre-colonial Southern Africa.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_mapungubwe"}]
  },
  {
    id: 'art_nok_flutist',
    name: 'Nok Terracotta Flutist Statue',
    civilizationId: 'nok',
    civilizationName: 'Nok Culture',
    date: '500 BCE',
    startYear: -500,
    ...
    currentLocation: 'Lagos, Nigeria',
    importanceScore: 8,
    imageUrl: '/images/artifacts/art_nok_flutist.jpg',
    historicalContext: 'A terracotta figure representing a musician playing a wind instrument, showing elaborate hair designs and detailed posture.',
    discoveryNotes: 'Discovered during alluvial gravel panning in the Nok region.',
    datingMethod: 'Thermoluminescence testing.',
    scholarlyDebates: 'Identifies that musical performance was highly institutionalized in Nok society.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_nok_smelting"}]
  },
  {
    id: 'art_mexica_serpent',
    name: 'Aztec Turquoise Mosaic Double-Headed Serpent',
    civilizationId: 'mexica',
    civilizationName: 'Mexica Empire',
    date: '1500 CE',
    startYear: 1500,
    material: ["Wood","Turquoise tiles","Spondylus shell","Pine resin"],
    museum: 'British Museum (held)',
    currentLocation: 'London, United Kingdom',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_mexica_serpent.jpg',
    historicalContext: 'A wooden sculpture of a double-headed serpent coated in thousands of tiny polished turquoise mosaic tiles, representing the god Quetzalcoatl.',
    discoveryNotes: 'Acquired by European collectors, likely among the gifts sent by Moctezuma II to Cortés.',
    datingMethod: 'Stylistic and historical timeline correlation.',
    scholarlyDebates: 'Debated as either a ceremonial chest pectoral worn by high priests or a ritual scepter.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_mexica"}]
  },
  {
    id: 'art_taino_duho',
    name: 'Taíno Ceremonial Wooden Seat (Duho)',
    civilizationId: 'taino',
    civilizationName: 'Taíno People',
    date: '1300 CE',
    startYear: 1300,
    material: ["Guayacan wood","Gold sheet inlay"],
    museum: 'Museo del Hombre Dominicano',
    currentLocation: 'Santo Domingo, Dominican Republic',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_taino_duho.jpg',
    historicalContext: 'A low-curved wooden seat representing an ancestral animal spirit, used by Taíno caciques during cohoba sniffing rituals to receive guidance.',
    discoveryNotes: 'Recovered from cave chambers in Hispaniola.',
    datingMethod: 'Radiocarbon dating of wood fibers.',
    scholarlyDebates: 'Highlights that Caribbean leaders used physical thrones and political seat hierarchies pre-contact.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_taino"}]
  },
  {
    id: 'art_butuan_strip',
    name: 'Butuan Silver Paleograph Strip',
    civilizationId: 'srivijaya',
    civilizationName: 'Srivijaya Empire',
    date: '10th Century CE',
    startYear: 900,
    material: ["Silver metal sheet"],
    museum: 'National Museum of the Philippines',
    currentLocation: 'Manila, Philippines',
    importanceScore: 8,
    imageUrl: '/images/artifacts/art_butuan_strip.jpg',
    historicalContext: 'A thin strip of silver metal containing inscribed characters, representing early literacy and commercial contracts in the Srivijaya trade orbit.',
    discoveryNotes: 'Uncovered in Butuan (Mindanao) during canal drainage cuts.',
    datingMethod: 'Epigraphical script style comparison matching Kawi script.',
    scholarlyDebates: 'Confirms trade contracts and written records were widely used in maritime Southeast Asia prior to Spanish contact.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_srivijaya"}]
  },
  {
    id: 'art_timbuktu_astrolabe_doc',
    name: 'Timbuktu Astrolabe Navigation Manuscript',
    civilizationId: 'mali',
    civilizationName: 'Mali Empire',
    date: '15th Century CE',
    startYear: 1400,
    material: ["Paper","Indigo and carbon ink"],
    museum: 'Mamma Haidara Commemorative Library',
    currentLocation: 'Timbuktu, Mali',
    importanceScore: 9,
    imageUrl: '/images/artifacts/art_timbuktu_astrolabe_doc.jpg',
    historicalContext: 'A paper manuscript depicting the geometric design of a brass astrolabe, used to calculate latitude and coordinate desert transits.',
    discoveryNotes: 'Preserved by local families in Timbuktu during colonial rule, now cataloged in the Haidara collection.',
    datingMethod: 'Paper watermarks and scribal dynastic dates.',
    scholarlyDebates: 'Refutes the idea that astronomical navigation was imported to Mali solely from external Arabic sources, showing local scholarly adaptation.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_timbuktu"}]
  },
  {
    id: 'art_lapis_seal',
    name: 'Achaemenid Lapis Lazuli Cylinder Seal',
    civilizationId: 'achaemenid',
    civilizationName: 'Achaemenid Empire',
    date: '500 BCE',
    startYear: -500,
    ...
    importanceScore: 8,
    imageUrl: '/images/artifacts/art_lapis_seal.jpg',
    historicalContext: 'A deep blue lapis lazuli cylinder seal depicting a Persian king conquering lions under the wings of the solar god Faravahar.',
    discoveryNotes: 'Purchased by the Met, sourced from Persian satrapies.',
    datingMethod: 'Stylistic and metallurgical carving analysis.',
    scholarlyDebates: 'Identifies the wide trade of raw lapis lazuli from Badakhshan across Achaemenid administrative ports.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_persia"}]
  },
  {
    id: 'art_great_zimbabwe_soapstone_bird',
    name: 'Great Zimbabwe Soapstone Bird',
    civilizationId: 'great_zimbabwe',
    civilizationName: 'Great Zimbabwe',
    date: '13th Century CE',
    startYear: 1200,
    material: ["Soapstone"],
    museum: 'Great Zimbabwe Site Museum',
    currentLocation: 'Masvingo, Zimbabwe',
    importanceScore: 10,
    imageUrl: '/images/artifacts/art_great_zimbabwe_soapstone_bird.jpg',
    historicalContext: 'A carved soapstone bird figure combining human and avian features, originally mounted on the stone walls of the Great Enclosure.',
    discoveryNotes: 'Looted by Cecil Rhodes\' agents in the late 19th century, later returned to Zimbabwe.',
    datingMethod: 'Stylistic match to early Shona ancestors and wall layers.',
    scholarlyDebates: 'Served as the ultimate symbol of royal authority and ancestral mediation, now the national emblem of Zimbabwe.',
    evidenceTier: 'Established',
    sources: [{"sourceId":"src_mapungubwe"}]
  }
];
